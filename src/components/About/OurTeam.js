  ...
  return (
    <Fragment>
      <Row className="OurTeam-section pt--20 pb--20 ">
        ...
        <Row className="pt--20 pb--20 gy-4 gx-4">
          <Col lg={3}>
            <div className="blog-one-card">
              ...
              <div className="blog-one-card__detail">
                <div className="blog-one-card__detail pb--15">
                  <h5 className="OurTeam__title">Sam Alabama</h5>
          ...
          <Col lg={3}>
            <div className="blog-one-card">
              ...
              <div className="blog-one-card__detail">
                <div className="blog-one-card__detail pb--15">
                  <h5 className="OurTeam__title">Athen Kamsia</h5>
                  <p className="OurTeam__team-detail">Team Member</p>
                </div>
              </div>
            </div>
          ...
          <Col lg={3}>
            <div className="blog-one-card">
              ...
              <div className="blog-one-card__detail">
                <div className="blog-one-card__detail pb--15">
                  <h5 className="OurTeam__title">Jack Lentera</h5>
                  <p className="OurTeam__team-detail">Team Member</p>
                </div>
              </div>
            </div>
          ...
          <Col lg={3}>
            <div className="blog-one-card">
              ...
              <div className="blog-one-card__detail">
                <div className="blog-one-card__detail pb--15">
                  <h5 className="OurTeam__title">Ahmad Pucelle</h5>
                  <p className="OurTeam__team-detail">Team Member</p>
                </div>
              </div>
            </div>
